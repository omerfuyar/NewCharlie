...
int main(int argc, char **argv)
{
    ...
    if (argc > 1)
    {
        ...
        SHU_CompilerAddFlags(SHUM_FLAGS_DEBUG SHUM_FLAGS_WARNING_ERROR " -Wno-unused-command-line-argument -Wno-gnu-zero-variadic-macro-arguments -Wno-missing-declarations -Wno-switch -Wno-format-truncation -Wno-unused-function -DDEBUG -Wno-format-nonliteral");
    }
    else
    {
